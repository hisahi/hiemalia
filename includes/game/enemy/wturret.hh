...
/*                                                                          */
/****************************************************************************/
// game/enemy/wturret.hh: header file for game/enemy/wturret.cc

#ifndef M_GAME_ENEMY_WTURRET_HH
#define M_GAME_ENEMY_WTURRET_HH

#include "game/enemy.hh"

namespace hiemalia {
class EnemyWheeledTurret : public EnemyObject {
  public:
    EnemyWheeledTurret(const Point3D& pos, const Orient3D& rot);
  ...
  private:
    ...
    void moveAround(GameWorld& w, float delta);
