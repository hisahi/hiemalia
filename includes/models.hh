...
inline auto modelFileNames = hiemalia::makeArray<std::string>(
    {"ship.3d",     "box.3d",      "tcube.3d",    "tetra.3d",    "shard.3d",
     ...
     "fuzzball.3d", "dstroyer.3d", "orbiter.3d",  "bouncer.3d",  "boss4.3d",
     "boss5.3d",    "boss5b.3d",   "wturret.3d",  "launcher.3d", "pewpew.3d",
     "pod.3d",      "blocker.3d",  "boss6.3d",    "boss6b.3d",   "boss7.3d",
     "boss7b.3d",   "boss7c.3d",   "ebullet4.3d", "ebulletb.3d", "oblock.3d",
     "ebullet5.3d", "ebullet6.3d"});
};  // namespace hiemalia
